...
const onSubmit = async () => {
  await axios.post("/api/login-"+role, {
    "email": email.value,
        ...
        <div
          ...
          <form class="space-y-4" @submit.prevent="onSubmit">
            <div class="mb-8">
              ...
              <p class="text-gray-500 text-sm mt-4 leading-relaxed">Log in to your account and explore a world of
            ...
            <div>
              ...
              <div class="relative flex items-center">
                <input name="username" type="text" required
                  ...
                  placeholder="Enter user name" v-model="email" />
            ...
            <div class="!mt-8">
              <button type="submit"
                class="w-full shadow-xl py-3 px-4 text-sm tracking-wide rounded-lg text-white bg-primary hover:bg-blue-700 focus:outline-none">
                Log in
              </button>
            </div>

            <p class="text-sm !mt-8 text-center text-gray-800">Don't have an account <router-link to="/register"
