...
import InputGroup from '@/js/components/Forms/InputGroup.vue'
import DefaultAuthCard from '@/js/components/Forms/DefaultAuthCard.vue'
      ...
      <form method="post" @submit.prevent="onSubmit" >
        ...
        <div class="mt-6 text-center">
          <p class="font-medium">
            ...
            <router-link to="/auth/register" class="text-primary">S'inscrire</router-link>
          </p>
        </div>
      </form>
    </DefaultAuthCard>
